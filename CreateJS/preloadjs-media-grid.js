...
var MediaGrid = (function () {
    ...
    MediaGrid.prototype.handleLoadStartEvent = function (event) {
        console.log(event);
    };
    MediaGrid.prototype.handleProgressEvent = function (event) {
        console.log(event);
    };
    MediaGrid.prototype.handleCompletedEvent = function (event) {
        console.log(event);
    };
