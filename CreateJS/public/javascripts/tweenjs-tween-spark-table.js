...
var TweenJSTweenSparkTable = (function () {
    ...
    // --------------------------------------------------------------------------------------------------------------------
        ...
        this.dataProvider = [
            ...
            {
                type: createjs.Ease.backInOut,
                label: "backInOut"
            }, 
            {
                type: createjs.Ease.backOut,
                label: "backOut"
            }, 
            {
                type: createjs.Ease.bounceIn,
                label: "bounceIn"
            }, 
            {
                type: createjs.Ease.bounceInOut,
                label: "bounceInOut"
            }, 
            {
            ...
            {
                type: createjs.Ease.circOut,
                label: "circOut"
            }, 
            {
                type: createjs.Ease.cubicIn,
                label: "cubicIn"
            }, 
            {
                type: createjs.Ease.cubicInOut,
                label: "cubicInOut"
            }, 
            {
                type: createjs.Ease.cubicOut,
                label: "cubicOut"
            }, 
            {
                type: createjs.Ease.elasticIn,
                label: "elasticIn"
            }, 
            {
                type: createjs.Ease.elasticInOut,
                label: "elasticInOut"
            }, 
            {
                type: createjs.Ease.elasticOut,
                label: "elasticOut"
            }, 
            {
                type: createjs.Ease.linear,
                label: "linear"
            }, 
            {
                type: createjs.Ease.none,
                label: "none"
            }, 
            {
                type: createjs.Ease.quadIn,
                label: "quadIn"
            }, 
            {
                type: createjs.Ease.quadInOut,
                label: "quadInOut"
            }, 
            {
                type: createjs.Ease.quadOut,
                label: "quadOut"
            }, 
            {
                type: createjs.Ease.quartIn,
                label: "quartIn"
            }, 
            {
                type: createjs.Ease.quartInOut,
                label: "quartInOut"
            }, 
            {
                type: createjs.Ease.quartOut,
                label: "quartOut"
            }, 
            {
                type: createjs.Ease.quintIn,
                label: "quintIn"
            }, 
            {
                type: createjs.Ease.quintInOut,
                label: "quintInOut"
            }, 
            {
                type: createjs.Ease.quintOut,
                label: "quintOut"
            }, 
            {
                type: createjs.Ease.sineIn,
                label: "sineIn"
            }, 
            {
                type: createjs.Ease.sineInOut,
                label: "sineInOut"
            }, 
            {
                type: createjs.Ease.sineOut,
                label: "sineOut"
            }, 
            {
                type: "divider",
            ...
            {
                type: createjs.Ease.getBackIn(2.5),
                label: "getBackIn"
            }, 
            {
                type: createjs.Ease.getBackInOut(2.5),
                label: "getBackInOut"
            }, 
            {
                type: createjs.Ease.getBackOut(2.5),
                label: "getBackOut"
            }, 
            {
                type: createjs.Ease.getElasticIn(2, 5),
                label: "getElasticIn"
            }, 
            {
                type: createjs.Ease.getElasticInOut(2, 5),
                label: "getElasticInOut"
            }, 
            {
                type: createjs.Ease.getElasticOut(2, 5),
                label: "getElasticOut"
            }, 
            {
                type: createjs.Ease.getPowIn(2.5),
                label: "getPowIn"
            }, 
            {
                type: createjs.Ease.getPowInOut(20.5),
                label: "getPowInOut"
            }, 
            {
                type: createjs.Ease.getPowOut(2.5),
                label: "getPowOut"
            }
        ];
