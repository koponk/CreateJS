...
class PreloadQueue {
	...
	private handleFileLoad( event: createjs.PreloadEventArgs ):void
	{		
	...
	private handleOverallProgress( event: createjs.PreloadOverallProgressEventArgs ):void
	{
	...
	private handleFileError( event: createjs.PreloadEventArgs ):void
	{
		var div = this.m_Map[event.src];
		div.addClass("error");
	}
